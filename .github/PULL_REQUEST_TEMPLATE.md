---
name: Pull Request
about: Submit a pull request to improve the PR Quality Analyzer
labels: needs review
---
...
## Testing
- [ ] Tested locally (opened index.html or ran dev server)
- [ ] Verified the analyzer works with example PRs
...
---
[![PR Quality](https://img.shields.io/badge/PR%20Quality-Check%20Your%20Score-brightgreen)](https://creativecodingsolutions.github.io/pr-quality-analyzer/?pr=REPLACE_WITH_PR_URL)
